...
var creatorList = ['Hafidz Abdillah','Apitt'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'api key is invalid, please create api key first'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'api key is invalid, please create api key firsta'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'sayahafiz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'sayahafiz') return res.json(loghandler.invalidKey)
